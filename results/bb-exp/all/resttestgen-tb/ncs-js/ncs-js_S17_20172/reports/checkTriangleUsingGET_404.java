...
public class checkTriangleUsingGET_404 {
	...
	public void checkTriangleUsingGET_TEST_404() throws Exception {
	{
		...
		Integer integer490391704 = Integer.valueOf("1");
	
		Integer integer460570271 = Integer.valueOf("90");
	
	
		ExecutionResult executionresult1653361344;
		try {
			// API Call
			Object returnValue_executionresult1653361344 = new NcsRestApi().checkTriangleUsingGETWithHttpInfo(integer490391704,integer460570271,integer490391704);
